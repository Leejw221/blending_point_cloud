...
def voxel_blending(femto_points, d405_points, voxel_size=0.005):
    """
    ...
    try:
        while True:
            ...
            rgbd_image = o3d.geometry.RGBDImage.create_from_color_and_depth(
                ...
                depth_trunc=0.15,  # 15cm max depth (camera frame Z axis)
            ...
            blended_point_cloud = voxel_blending(
                ...
                voxel_size=0.005  # 5mm voxels (RISE compatible)
            )
